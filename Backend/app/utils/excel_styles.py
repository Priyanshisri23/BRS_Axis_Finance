...
def color_excel(brs_output_file,t_1_date):
    ...
    # Apply cell style for the data rows (yellow background for values) BA0465
    key_fill = PatternFill(start_color="CC0066", end_color="CC0066", fill_type="solid")
    ...
    for row in range(2, 12):  # Rows 2 to 10
